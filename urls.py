...
from handlsers.view import IndexView,ShebeiView,UserView,AddShebei,DongjieShebeiView,JieShebeiView,AddUserView,QuxiaoAdmin,ShezhiAdmin,DongjieUser,JieDUser,ChongzhiUser
url=[
    ('/login',LoginView),
    ('/logout',LogoutView),
    ('/index',IndexView),
